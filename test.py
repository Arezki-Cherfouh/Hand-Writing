...
# reset_button = Button(
#     GRID_OFFSET_X + GRID_SIZE * CELL_SIZE + BUTTON_MARGIN,
#     GRID_OFFSET_Y + 100 + BUTTON_HEIGHT + BUTTON_MARGIN,
#     BUTTON_WIDTH,
#     BUTTON_HEIGHT,
#     "Reset",
#     RED
...
#     # Center the image (find bounding box and center it)
...
#     global grid, prediction, confidence
#     grid = np.zeros((GRID_SIZE, GRID_SIZE), dtype=np.float32)
#     prediction = None
#     confidence = None
...
#     # Draw title
#     title_surface = title_font.render("Handwriting Recognition", True, BLACK)
#     screen.blit(title_surface, (WINDOW_WIDTH // 2 - title_surface.get_width() // 2, 10))
    
#     # Draw instructions
#     instruction_surface = info_font.render("Draw a digit (0-9) on the grid", True, DARK_GRAY)
...
#         label_surface = button_font.render("Prediction:", True, BLACK)
...
#         confidence_surface = info_font.render(confidence_text, True, DARK_GRAY)
...
#     # Draw title
#     title_surface = title_font.render("Handwriting Recognition", True, TEXT_PRIMARY)
#     screen.blit(title_surface, (WINDOW_WIDTH // 2 - title_surface.get_width() // 2, 10))
    
#     # Draw instructions
#     instruction_surface = info_font.render("Draw a digit (0-9) on the grid", True, TEXT_SECONDARY)
#     screen.blit(instruction_surface, (GRID_OFFSET_X, GRID_OFFSET_Y + GRID_SIZE * CELL_SIZE + 20))
...
pygame.init()
screen = pygame.display.set_mode((WINDOW_WIDTH, WINDOW_HEIGHT))
pygame.display.set_caption("Handwriting Recognition - Dark Mode + Image Loading")
